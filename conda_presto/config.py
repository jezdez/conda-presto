...
Server tuning:
    ...
    ``CONDA_PRESTO_SOLVER_ENDPOINT``
        Enable the internal solver-backend endpoint (default: ``false``).
        Only the broker-managed loopback service enables this.
...
SOLVER_ENDPOINT = env_bool("CONDA_PRESTO_SOLVER_ENDPOINT")
