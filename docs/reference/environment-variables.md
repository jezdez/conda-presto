...
| `CONDA_PRESTO_SOLVER_CACHE_WARM_CANDIDATE_SIZE` | `32` | Maximum successful cacheable foreground `/solver/v1` requests retained as cache-warming candidates. Set to `0` to disable recording. |
